<%@ Page Title="" Language="C#" MasterPageFile="~/DashboardMaster.Master" AutoEventWireup="true" CodeBehind="ScheduleMatch.aspx.cs" Inherits="Athle_E_Team_Project.ScheduleMatch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
              ...
              <h6 class="font-weight-light">&nbsp;</h6></th>
                  ...
                  <asp:TextBox ID="txtdate" runat="server" class="form-control form-control-lg" placeholder="Date" ></asp:TextBox>
                    ...
                    <asp:TextBox ID="txtlandmark" runat="server" class="form-control form-control-lg" placeholder="Land Mark" ></asp:TextBox>
                </div></td>
                        <td><div class="form-group">
